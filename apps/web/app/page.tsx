        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-24 md:py-32 text-center">
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto mb-10">
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl opacity-30 group-hover:opacity-50 blur transition-all duration-300" />
              <div className="relative flex items-center bg-gray-900 rounded-2xl border border-gray-700/50">
                <div className="pl-5">
                ...
                <input
                  type="text"
                  placeholder="Search mentors by name, expertise, or category..."
                  value={searchQuery}
                ...
                <button
                  type="submit"
                  className="mr-2 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-medium rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25"
                >
                  Search
                </button>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-4">
              ...
              {['Software Engineer', 'Visa Help', 'Medical License', 'Career Coach'].map((term) => (
                <button
                  key={term}
                  type="button"
                  onClick={() => router.push(`/search?q=${encodeURIComponent(term)}`)}
                  className="px-3 py-1 text-sm text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-700/50 rounded-lg transition-colors"
                >
                  {term}
                </button>
              ))}
