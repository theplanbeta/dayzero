...
const MOCK_MENTORS: Mentor[] = [
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/Deepak_Image.webp?v=1719177426&width=533',
    rating: 4.9,
    sessionCount: 127,
    pricePerSession: 25,
    category: 'Healthcare',
  ...
  },
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/20230211_134758-01.jpg?v=1719177429&width=533',
    rating: 4.8,
    sessionCount: 98,
    pricePerSession: 25,
  ...
  },
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/20230804_193847.jpg?v=1719177456&width=533',
    rating: 4.85,
    sessionCount: 76,
    pricePerSession: 25,
    category: 'Engineering',
  ...
  },
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/jithin.heic?v=1719177429&width=533',
    rating: 4.95,
    sessionCount: 156,
    pricePerSession: 40,
    category: 'Healthcare',
  ...
  },
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/jomon2.png?v=1719177422&width=533',
    rating: 4.7,
    sessionCount: 89,
    pricePerSession: 25,
    category: 'Healthcare',
  ...
  },
  {
    ...
    name: 'Guru Kurakula',
    headline: 'Doctor doing Specialisation in Germany',
    avatar: 'https://planbeta.in/cdn/shop/files/Seehstern-1208.jpg?v=1719177456&width=533',
    rating: 4.8,
    sessionCount: 134,
    pricePerSession: 25,
    category: 'Healthcare',
  ...
  },
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/20230408_162659_3923ada8-c849-4561-9b9a-bd66768afa6b.jpg?v=1719177466&width=533',
    rating: 4.85,
    sessionCount: 112,
    pricePerSession: 25,
    category: 'Engineering',
  ...
  },
  {
    ...
    avatar: 'https://planbeta.in/cdn/shop/files/WhatsAppImage2023-07-30at23.13.01.jpg?v=1719177461&width=533',
    rating: 4.75,
    sessionCount: 67,
    pricePerSession: 25,
    category: 'Education',
